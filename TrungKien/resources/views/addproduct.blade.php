						...
						<div class="row" style="margin-bottom:40px">
							...
							@if ($errors->any())
								...
								<div class="form-group">
									...
									<select class="form-control" name="ProductType" id="addProductType">
								...
								<div class="form-group">
									...
									<select class="form-control" name="ProductCategory" id="addCategory">
								...
								<div class="form-group">
									...
									<input required id="img" type="file" name="ProductImage[]" class="form-control" multiple accept="image/png, image/jpeg,image/jpg" style="display:none">
